<?php
  ...
  function mostrarSeccionEditar(){
    ...
    if(!empty($materia)){
      formularioEditar($materia->nombre, $materia->nombre_profesor);
    }
  }

  function formularioEditar($nombre_materia, $nombre_profesor){?>
    ...
    <form>
      ...
      <a href="editarMateriaDB"><button>Agregar</button></a> 
      <a href="inicio"><button>Cancelar</button></a>
    </form>
    <?php
  }

  function tabla($argumentos = null){?>
    <table>
      <thead>
        <tr>
          <td>Materia</td>
